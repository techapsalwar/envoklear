...
import { Monitor, Tablet, Smartphone, ArrowLeft, X } from 'lucide-react';
...
export default function PortfolioEdit({ portfolio }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        color: portfolio.color || 'from-blue-500 to-cyan-500',
        image_desktop: null,
        image_tablet: null,
        image_mobile: null,
    ...
    const [previews, setPreviews] = useState({
        desktop: portfolio.image_desktop || null,
        tablet: portfolio.image_tablet || null,
        mobile: portfolio.image_mobile || null,
    });
    ...
    const handleImageChange = (type, e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                setNewPreviews(prev => ({ ...prev, [type]: reader.result }));
            };
            ...
            <Card className="p-6">
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="border-t pt-6">
                        ...
                        <p className="text-sm text-gray-500 mb-6">Upload new screenshots to replace existing ones.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                {(newPreviews.desktop || previews.desktop) && (
                                    <div className="mt-3 relative">
                                        <img 
                                            src={newPreviews.desktop || previews.desktop} 
                                            alt="Desktop Preview" 
                                            className="rounded-lg shadow-md max-h-40 w-full object-cover" 
                                        />
                                        {newPreviews.desktop && (
                            ...
                            <div>
                                ...
                                {(newPreviews.tablet || previews.tablet) && (
                                    <div className="mt-3 relative">
                                        <img 
                                            src={newPreviews.tablet || previews.tablet} 
                                            alt="Tablet Preview" 
                                            className="rounded-lg shadow-md max-h-40 w-full object-cover" 
                                        />
                                        {newPreviews.tablet && (
                            ...
                            <div>
                                ...
                                {(newPreviews.mobile || previews.mobile) && (
                                    <div className="mt-3 relative">
                                        <img 
                                            src={newPreviews.mobile || previews.mobile} 
                                            alt="Mobile Preview" 
                                            className="rounded-lg shadow-md max-h-40 w-full object-cover" 
                                        />
                                        {newPreviews.mobile && (
